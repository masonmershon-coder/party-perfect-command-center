import { completeIntake } from "@/lib/mike-intake";
...
/** POST /api/mike/intake/complete — COMPLETE (same device bearer). */
export async function POST(request: Request) {
  const result = await completeIntake(request, productionIntakeDeps());
