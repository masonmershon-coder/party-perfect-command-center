...
export function MarkRepliedButton({
  ...
  return (
    <button
      ...
      disabled={disabled}
      onClick={onClick}
      className={`rounded-lg border border-emerald-500/50 bg-emerald-500/10 font-medium text-emerald-600 transition hover:bg-emerald-500/20 disabled:opacity-50 ${
