...
export function VersionBadge() {
  return (
    <div
      className="pointer-events-none fixed bottom-[4.75rem] right-3 z-20 select-none rounded-md border border-[var(--pp-border)] bg-[var(--pp-panel)]/90 px-2 py-1 backdrop-blur-sm lg:bottom-3 lg:z-30"
